...
struct EGB_ScreenMode EGB_SCREENMODES[19]=
{
	...
	{ // Mode 1
		...
		{640,400}, //struct POINTW crtcSize
	...
	{ // Mode 5
		...
		SCRNMODE_FLAG_STARTPOS|SCRNMODE_FLAG_HSCROLL|SCRNMODE_FLAG_VSCROLL|SCRNMODE_FLAG_DISPSIZE,//unsigned int flags;
		{1,1},//struct POINTW defZoom;
	...
	{ // Mode 7
		...
		{1280,480}, //struct POINTW crtcSize (Max HDE-HDS,VDE-VDS)
		{256,512}, //struct POINTW size;
		512,//unsigned short bytesPerLine;
		9,//unsigned short bytesPerLineShift;  // 0:Can not shift  Non-Zero:Can shift (bytesPerLine is 2^n)
		16,//unsigned char bitsPerPixel;
	...
	{ // Mode 8
		15, // KHz
		{256,240}, //struct POINTW visiSize;
		{1280,480}, //struct POINTW crtcSize
		{256,512}, //struct POINTW size;
		512,//unsigned short bytesPerLine;
		9,//unsigned short bytesPerLineShift;  // 0:Can not shift  Non-Zero:Can shift (bytesPerLine is 2^n)
		16,//unsigned char bitsPerPixel;
	...
	{ // Mode 9
		...
		{1440,480}, //struct POINTW crtcSize
	...
	{ // Mode 10
		...
		SCRNMODE_FLAG_STARTPOS|SCRNMODE_FLAG_VSCROLL|SCRNMODE_FLAG_HSCROLL|SCRNMODE_FLAG_DISPSIZE,//unsigned int flags;
		{1,1},//struct POINTW defZoom;
	...
	{ // Mode 15
		...
		SCRNMODE_FLAG_VSCROLL|SCRNMODE_FLAG_HSCROLL|SCRNMODE_FLAG_DISPSIZE,//unsigned int flags;
		{2,1},//struct POINTW defZoom;
	...
	{ // Mode 17
		...
		SCRNMODE_FLAG_HSCROLL|SCRNMODE_FLAG_VSCROLL|SCRNMODE_FLAG_DISPSIZE,//unsigned int flags;
		{1,1},//struct POINTW defZoom;
	...
	{ // Mode 18
		15, // KHz
		{512,480}, //struct POINTW visiSize;
		{1024,480}, //struct POINTW crtcSize
		{512,512}, //struct POINTW size;
		1024,//unsigned short bytesPerLine;
		10,//unsigned short bytesPerLineShift;  // 0:Can not shift  Non-Zero:Can shift (bytesPerLine is 2^n)
		16,//unsigned char bitsPerPixel;
